...
const CoachCreatePage = () => {
	...
	const handleSubmit = async () => {
		...
		try {
			let imageUrl = null;
			if (tempImageFile) {
				imageUrl = await uploadImage(tempImageFile, "course", userData.id);
				if (!imageUrl) {
				...
				<div className="p-create__section">
					...
					<div className="p-create__input-wrapper -textarea">
						<MultilineInput
							...
							placeholder="ポケカを始めたばかりの方向けの講座です。&#10;デッキの組み方の基礎、エネルギー管理の考え方、&#10;対戦中の基本的な判断（いつサポートを使うか、バトル場とベンチの使い分け等）を&#10;あなたのデッキに合わせて丁寧にお伝えします。&#10;&#10;「構築済みデッキを買ったけど、ここからどうすればいいかわからない」&#10;「対戦してもなんとなく負けてしまう」という方にぴったりです。&#10;&#10;講座の進め方&#10;① ヒアリング（5分）: 現在のデッキや悩みをお聞きします&#10;② 対戦＆アドバイス（20分）: 実際に対戦しながらプレイングのコツを解説&#10;③ まとめ（5分）: 今後の練習ポイントを整理してお伝えします&#10;&#10;必要なもの:&#10;PTCGLive or 実物カード / デッキレシピ / Discord&#10;&#10;料金: 1,000円（30分）"
							minHeight={300}
							maxHeight={300}
						/>
					</div>
